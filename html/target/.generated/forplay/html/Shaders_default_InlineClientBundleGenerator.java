...
public class Shaders_default_InlineClientBundleGenerator implements forplay.html.Shaders {
  ...
  private void colorFragmentShaderInitializer() {
    colorFragmentShader = new com.google.gwt.resources.client.TextResource() {
      // jar:file:/home/luigi/workspaces/games/forplay_trunk/core/target/core-1.0-SNAPSHOT.jar!/forplay/html/color-fragment-shader.txt
  ...
  private void texFragmentShaderInitializer() {
    texFragmentShader = new com.google.gwt.resources.client.TextResource() {
      // jar:file:/home/luigi/workspaces/games/forplay_trunk/core/target/core-1.0-SNAPSHOT.jar!/forplay/html/tex-fragment-shader.txt
      public String getText() {
  ...
  private void vertexShaderInitializer() {
    vertexShader = new com.google.gwt.resources.client.TextResource() {
      // jar:file:/home/luigi/workspaces/games/forplay_trunk/core/target/core-1.0-SNAPSHOT.jar!/forplay/html/vertex-shader.txt
      public String getText() {
  ...
  private native ResourcePrototype getResourceNative(String name) /*-{
    switch (name) {
      case 'colorFragmentShader': return this.@forplay.html.Shaders::colorFragmentShader()();
      case 'texFragmentShader': return this.@forplay.html.Shaders::texFragmentShader()();
      case 'vertexShader': return this.@forplay.html.Shaders::vertexShader()();
    }
    return null;
  }-*/;
}
